                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" name="counter_number" id="counter_number"
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <InputError class="text-sm py-3 mb-2" :message="validations_errors.counter_number" :text_size="'text-sm'" />
                                        </div>
                                        <div class="">
                                            <label for="office_id"
                                            ...
                                            <InputError class="text-sm py-3 mb-2" :message="validations_errors.office_id" :text_size="'text-sm'" />
                                        </div>
