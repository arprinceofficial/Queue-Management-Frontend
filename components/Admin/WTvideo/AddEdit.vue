<script setup>
    ...
    const {
        $api_admin_wt_video_create,
        $api_admin_wt_video_update,
    } = useNuxtApp();
    ...
    const emit = defineEmits(['add_video', 'cancel']);
    ...
    const createVideo = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_wt_video_create, {
                method: 'POST',
                body: formData.value,
            });
            response_modal.value = getData;
            if(getData.status == true){
                emit('add_video', getData.data);
            }
        } catch(e){
    ...
    const updateVideo = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_wt_video_update, {
                method: 'POST',
                body: formData.value,
            });
            response_modal.value = getData;
                            ...
                            <DialogPanel
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-6">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="text" name="link" id="link"
                                                ...
                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                            <InputError class="text-sm py-3 mb-2" :message="validations_errors.link" :text_size="'text-sm'" />
                                        </div>
                                        <div class="">
                                ...
                                <div class="mt-4 flex justify-end">
                                    ...
                                    <button type="button"
                                        ...
                                        @click="title == 'Add' ? createVideo() : updateVideo()">
