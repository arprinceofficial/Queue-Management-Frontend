<script setup>
    ...
    const {
        $api_admin_gender_create,
        $api_admin_gender_update,
    } = useNuxtApp();
    ...
    const createGender = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_gender_create, {
                method: 'POST',
                body: formData.value,
            });
            if(getData.status == true){
                emit('add_gender', getData.data);
            }
        } catch(e){
    ...
    const updateGender = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_gender_update, {
                method: 'POST',
                body: formData.value,
            });
            if(getData.status == true){
