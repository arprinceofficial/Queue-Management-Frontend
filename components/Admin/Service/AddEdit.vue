<script setup>
    ...
    const emit = defineEmits(['add_service', 'cancel']);
    ...
    const createService = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_service_create, {
                method: 'POST',
                body: formData.value,
            });
            response_modal.value = getData;
            if(getData.status == true){
                emit('add_service', getData.data);
            }
        } catch(e){
    ...
    const updateService = async () => {
        ...
        try{
            ...
            const getData = await $fetchAdmin($api_admin_service_update, {
                method: 'POST',
                body: formData.value,
            });
            response_modal.value = getData;
                            ...
                            <DialogPanel
                                ...
                                <div class="mt-4 flex justify-end">
                                    ...
                                    <button type="button"
                                        ...
                                        @click="title == 'Add' ? createService() : updateService()">
