                            ...
                            <template #trigger>
                                <span class="inline-flex rounded-md">
                                    <button type="button"
                                        ...
                                        <img class="h-8 w-8 rounded-full object-cover" :src="agent_user?.data?.image ?? '/img/profile-image.png'" :class="!agent_user?.data?.image ? 'bg-gray-200 p-1' : ''"
                                        alt="image" />
                                        <span class="pr-2 pl-2">{{ agent_user?.data?.name }}</span>
                                    </button>
                                </span>
                            </template>
                                ...
                                <div class="py-2 border-b border-gray-200 dark:border-gray-600">
                                    <div class="px-4">
                                        <div class="font-medium text-sm text-gray-800 dark:text-gray-200">
                                            {{ agent_user?.data?.name }}
                                        </div>
                                        <div class="font-medium text-sm text-gray-500">{{ agent_user?.data?.email }}</div>
                                    </div>
                                </div>
