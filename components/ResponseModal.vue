                            ...
                            <div class="mt-2">
                                ...
                                <div class="flex flex-wrap pr-3 pl-3">
                                    <div class="flex items-start w-full justify-center items-center">
                                        <div v-if="!response_modal" class="flex justify-center items-center h-40">
                                        ...
                                        <div v-else
                                                            ...
                                                            <svg viewBox="0 0 87 87" version="1.1"
                                                                ...
                                                                <g id="Page-1" stroke="none" stroke-width="1" fill="none"
                                                                    ...
                                                                    <g id="Group-3"
                                                                        ...
                                                                        <circle class="ui-success-circle" id="Oval-2"
                                                                            stroke="#A5DC86" stroke-width="4" cx="41.5"
                                                                            cy="41.5" r="41.5"></circle>
                                                                        <polyline class="ui-success-path" id="Path-2"
                                                                            stroke="#A5DC86" stroke-width="4"
                                            ...
                                            <div v-if="messageLogs" class="text-start">
                                                <p v-for="msg in messageLogs" class="text-red-700 text-lg font-medium text-gray-900 dark:text-white text-wrap pb-2">
                                                    {{ msg }}
                                                </p>
                                            </div>
