<template>
    <div class="flex items-center justify-center">
        <div class="relative flex justify-center border border-collapse border-[#ddd] rounded-md" :style="`width:${width}px;height:${height}px`">
            ...
            <div :class="['absolute inline-flex items-center justify-center cursor-pointer transition-all',Photo?'bg-green-600 bg-opacity-30 hover:bg-opacity-100 text-white text-[11px] h-6 px-3 bottom-8 gap-2 rounded-2xl':'text-gray-400 w-full h-full left-0 top-0']" @click="upload_photo">
