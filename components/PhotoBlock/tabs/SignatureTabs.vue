<template>
    <div>
      <div class="sm:hidden">
        ...
        <select id="tabs" name="tabs" class="block w-full rounded-md border-gray-300 focus:border-green-500 focus:ring-green-500" v-model="sel_tab_index">
