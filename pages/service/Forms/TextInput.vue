...
<template>
    <div class="mt-6">
        ...
        <div v-if="!preview_mode" class="flex">
            ...
            <InputText
                :type="data.type"
                class="h-[72px] sm:text-xl text-[20px] rounded-lg"
        ...
        <div v-else class="flex flex-wrap gap-3 mt-1">
            <div class="h-[72px] sm:text-xl text-[20px] rounded-lg flex w-full border-[1px] border-[solid] border-gray-300 [box-shadow:0px_1px_3px_0px_rgba(0,_0,_0,_0.05)] items-center px-3 bg-[#F7F7F7] cursor-not-allowed">
